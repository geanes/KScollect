                  ...
                  column_xs(width = 7,
                    div(class = "tab-content",
                        div(role = "tabpanel", class = "tab-pane active fade in", id = "humerus",
                          ...
                          add_attribs(numericInput("HMSB", "Midshaft breadth", value = NA, min = 0, width = "100%"), tabindex = 16),
                          add_attribs(numericInput("HPB", "Proximal breadth", value = NA, min = 0, width = "100%"), tabindex = 17),
                        ...
                        div(role = "tabpanel", class = "tab-pane fade", id = "radius",
                            ...
                            add_attribs(numericInput("RMSB", "Midshaft breadth", value = NA, min = 0, width = "100%"), tabindex = 23),
                            add_attribs(numericInput("RPB", "Proximal breadth", value = NA, min = 0, width = "100%"), tabindex = 24),
                        ...
                        div(role = "tabpanel", class = "tab-pane fade", id = "tibia",
                            ...
                            add_attribs(numericInput("TMSB", "Midshaft breadth", value = NA, min = 0, width = "100%"), tabindex = 37),
                            add_attribs(numericInput("TPB", "Proximal breadth", value = NA, min = 0, width = "100%"), tabindex = 38),
